...
void morpion(joueur rep[]) {
    ...
    while(i != 1){
        ...
        switch(choix){
            case 1 :
                printf("Saisir le nom du premier player :\n");
                scanf(" %s", repmorp[0].nom);
                printf("Saisir le nom du second player :\n");
                scanf(" %s", repmorp[1].nom);
            ...
            case 2 :
                ...
                tournoi(tableau, repmorp, nombreJoueurs);
                break;
            case 3 :
                i = 1;
                break;
...
void tournoi(char tableau[nblignes][nbcolonnes], player repmorp[], int nombreJoueurs)
{
    int i = 0;
    system("cls");
    ...
    switch(nombreJoueurs){
        case 4 :
            ...
            for(i=0;i<4;i++){
                printf("Saisir le nom du player %d :\n", i+1);
                scanf(" %s", repmorp[i].nom);
            }
            //Match 1
            initTab(tableau);
            afficherTab(tableau);
